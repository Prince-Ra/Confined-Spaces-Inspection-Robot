...
class dvbs2_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Dvbs2 Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dvbs2 Rx")
        ...
        self.osmosdr_source_0.set_center_freq(900e6, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'decoded.ts', False)
        ...
        self.connect((self.dvbs2rx_rx_hier_0, 0), (self.dvbs2rx_bch_decoder_bb_0, 0))
        ...
        self.connect((self.dvbs2rx_rx_hier_0, 3), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.dvbs2rx_rx_hier_0, 4), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.dvbs2rx_rx_hier_0, 2), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.osmosdr_source_0, 0), (self.dvbs2rx_rx_hier_0, 0))
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.dvbs2rx_rx_hier_0.set_sym_rate(self.symbol_rate)
